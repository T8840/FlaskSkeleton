...
from {{cookiecutter.app_name}}.extensions import bcrypt, cache, cors, db, migrate, debug_toolbar, apispec
# 此处从urls导入是为了restful能正常加载到url设置
from {{cookiecutter.app_name}}.urls import blueprint
# 导入日志配置
from {{cookiecutter.app_name}}.settings import dictConfig
...
def createApp(configObject='{{cookiecutter.app_name}}.settings'):
